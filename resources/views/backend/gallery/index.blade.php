        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary btn-sm me-1" href="{{ route('gallery.create') }}" title="Hizmet Ekle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Add Gallery
                    </a>
                </div>
            ...
            <div class="table-responsive p-2">
                <table class="table table-hover table-striped table-bordered table-center">
                    ...
                    <tr id="page_{{$item->id}}">
                        <td>
                            <img class="avatar me-2" src="{{ (!$item->getFirstMediaUrl('page')) ? '/backend/resimyok.jpg': $item->getFirstMediaUrl('page')}}">
                        </td>
                        <td>
                            <div class="font-weight-medium">
                                <a href="{{ route('gallery.edit', $item->id) }}" title="Edit">{{ $item->title }}</a>
                            </div>
                        </td>
                        <td>
        ...
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between">
                <div>
                    <h4 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Gallery Category [{{ $Kategori->count() }}]
                    </h4>
                </div>
                <div>
                    <a class="btn btn-tabler btn-sm" href="{{ route('gallery-categories.index') }}" title="Hizmet Ekle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Add Categories
                    </a>
                </div>
                ...
                <table class="table table-hover table-striped table-bordered table-center">
                    ...
                    @foreach($Kategori  as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('gallery-categories.edit', $item->id) }}" title="Edit">{{ $item->title }}</a>
                            </td>
                            <td class="text-muted">
